...
def parse_args():
    ...
    parser.add_argument(
        '--image_path',
        dest='image_path',
        default='/home/chase/projects/DeadChicken/data/死鸡数据/image_2/',
        help='图片路径',
        type=str
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--train_path',
        dest='train_path',
        default='/home/chase/projects/DeadChicken/data/dead_chicken_train.json',
    ...
    parser.add_argument(
        '--val_path',
        dest='val_path',
        default='/home/chase/projects/DeadChicken/data/dead_chicken_valid.json',
